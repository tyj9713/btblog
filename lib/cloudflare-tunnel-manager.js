...
class CloudflareTunnelManager {
  ...
  sanitizeConfigInput(input = {}) {
    ...
    const config = {
      ...
      CLOUDFLARE_ACCOUNT_ID: text("CLOUDFLARE_ACCOUNT_ID"),
      CLOUDFLARE_TUNNEL_ID: text("CLOUDFLARE_TUNNEL_ID"),
      CLOUDFLARE_TUNNEL_REMOTE_CONFIG: "true",
      CLOUDFLARE_TUNNEL_LOCAL_CONFIG: "false",
      TUNNEL_NODE_HOSTNAME: text("TUNNEL_NODE_HOSTNAME"),
      TUNNEL_BT_HOSTNAME: text("TUNNEL_BT_HOSTNAME"),
      TUNNEL_PORT_DOMAIN: text("TUNNEL_PORT_DOMAIN"),
      TUNNEL_PORT_HOST_PREFIX: text("TUNNEL_PORT_HOST_PREFIX") || "p",
      TUNNEL_PORT_HOST_TEMPLATE: text("TUNNEL_PORT_HOST_TEMPLATE"),
      XRAY_PORT: text("XRAY_PORT") || "10086",
      BT_PORT: text("BT_PORT") || "8888",
    };
