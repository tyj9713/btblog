    ...
    if (settings.useRemoteConfig) {
      try {
        if (!settings.credentials) {
          routePublish = {
            skipped: true,
            reason: "token 无法解析 credentials，仅启动 connector",
          };
          this.appendLog("route publish skipped: token 无法解析 credentials，仅启动 connector");
        } else {
        ...
        if (routePublish.skipped && routePublish.reason === "CLOUDFLARE_API_TOKEN 未设置") {
          this.appendLog(
            "route publish skipped: CLOUDFLARE_API_TOKEN 未设置，将仅启动 connector"
          );
        } else if (routePublish.skipped) {
